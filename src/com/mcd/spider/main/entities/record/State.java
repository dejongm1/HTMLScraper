...
public final class State {
	...
	public static final State WI = new State("WISONSIN", "WI", new ArrayList<>(Arrays.asList(new ArrestsDotOrgEngine())));
	...
	public static final State MP = new State("NORTHERN MAIRAN ISLANDS", "MP", new ArrayList<>());
