...
public class SpiderConstants {
    ...
    public static final String HELP_MESSAGE_3 = "3 - Search for a term: " + "\n"
            ...
            + "  Flexibility: From 0-2, how flexible should the search be (0 is not flexible at all)" + "\n\n";
    public static final String HELP_MESSAGE_4 = "4 - Get records: " + "\n"
            ...
            + "          Defaults to 99999 " + "\n"
            + "  Start from Last Crawled: If a list of uncrawled records exists, crawl those alone." + "\n"
