...
//        site = new DesMoinesRegisterComSite(null);
    ...
    public Object initiateConnection(String county) throws IOException {
        ...
        String urlParameters = site.getRequestBody(new String[]{county, "getmugs", "0", String.valueOf(spiderWeb.getMaxNumberOfResults()==0?10000:spiderWeb.getMaxNumberOfResults()/site.getCounties().size())});
...
//					record.setCity(city);
            ...
            try {
                ...
                if (nameParts.length==2) {
                    ...
                    record.setLastName(nameParts[nameParts.length-1]);
                }
